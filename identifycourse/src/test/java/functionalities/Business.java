...
public class Business {
	...
	public void clickLogo() throws InterruptedException, IOException {
		...
		String path = System.getProperty("user.dir") + "\\screenshot\\Courses\\Business\\udemyLogo.png";
	...
	public void setFormValues() throws Exception {
		...
		File scrFile = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		String path = System.getProperty("user.dir") + "\\screenshot\\Courses\\Business\\udemyForm1.png";
		// Now we take a screenshot
		FileUtils.copyFile(scrFile, new File(path));
		...
		path = System.getProperty("user.dir") + "\\screenshot\\Courses\\Business\\udemForm2.png";
		// Now we take a screenshot
		FileUtils.copyFile(scrFile, new File(path));
