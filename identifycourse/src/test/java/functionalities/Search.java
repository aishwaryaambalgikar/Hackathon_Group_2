...
public class Search {
	...
	public void inputToSearchBar() throws IOException, InterruptedException {
		...
		InputFromExcel ife = new InputFromExcel();
		
		String course = ife.searchInput();
		...
		path = System.getProperty("user.dir") + "\\screenshot\\Courses\\Search\\InputSearch.png";

		// Now we take a screenshot
		FileUtils.copyFile(scrFile, new File(path));

		// Logging the screenshot
		ex.screenShotLog("Snapshot: Input to search", path);
		...
		path = System.getProperty("user.dir") + "\\screenshot\\Courses\\Search\\OutputSearch.png";
	...
	public void selectFilter() throws IOException {
		...
		path = System.getProperty("user.dir") + "\\screenshot\\Courses\\Search\\EnglishSelected.png";
		...
		path = System.getProperty("user.dir") + "\\screenshot\\Courses\\Search\\BeginnerSelected.png";
