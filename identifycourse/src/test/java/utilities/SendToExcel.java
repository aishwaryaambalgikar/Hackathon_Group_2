...
public class SendToExcel {
	...
	FileOutputStream fout = new FileOutputStream(
			System.getProperty("user.dir") + File.separator + "Excel_output" + File.separator + "output.xlsx");
	...
	public void levelResultToExcel(List<String> level, List<Integer> count) throws Exception {
		...
		while (itr.hasNext()) {
			...
			row1.createCell(0).setCellValue(itr.next());

			// Values from count list stored in second column
			row1.createCell(1).setCellValue(itrt.next());
		}
